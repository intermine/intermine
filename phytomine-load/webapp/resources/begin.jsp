                                            ...
                                            <center>
                                                <c:choose>
                                                    <c:when test="${!isNewUser && !empty (WEB_PROPERTIES['begin.thirdBox.visitedLink'])}">
                                                        <a class="button light" href="<c:out value="${WEB_PROPERTIES['begin.thirdBox.visitedLink']}" />"
                                                    ...
                                                    <c:otherwise>
                                                        <a class="button light" href="<c:out value="${WEB_PROPERTIES['begin.thirdBox.link']}" />"
