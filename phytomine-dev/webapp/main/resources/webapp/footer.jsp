...
<div class="body bottom-footer">
    <a class="jgi-logo" href="http://www.jgi.doe.gov/" title="DOE Joint Genome Institute" target="_blank">
        <img src="model/images/JGI.png" alt="DOE JGI logo">
        <!-- img src="images/icons/JGI.png" alt="DOE JGI logo" -->
    </a>
    ...
    <p class="footer-copy">&copy; 2013 University of California Reagents. All rights reserved. </p>
