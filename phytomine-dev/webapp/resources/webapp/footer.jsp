...
<div class="body bottom-footer">
    <a class="cambridge-logo" href="http://www.cam.ac.uk/" title="University of Cambridge" target="_blank">
        <img height="30px" src="images/icons/cambridge-footer-logo.png" alt="University of Cambridge logo">
    </a>

    <a style="float:left;" href="http://jgi.doe.gov/" title="DOE Joint Genome Institute" target="_blank">
        <img height="30px" src="model/images/JGI-logo.png" alt="DOE Joint Genome Institute logo">
    </a>
    ...
    <p class="footer-copy">Intermine &copy; 2002 - 2012 Department of Genetics, University of Cambridge, Downing Street,Cambridge CB2 3EH, United Kingdom <br/>
       Phytozome &copy; 2014 DOE Joint Genome Institute</p>
