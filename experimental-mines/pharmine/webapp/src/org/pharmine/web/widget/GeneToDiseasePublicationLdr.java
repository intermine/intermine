 ...
 */
public class GeneToDiseasePublicationLdr extends EnrichmentWidgetLdr
{
    private Collection<String> organisms = new ArrayList<String>();
    private Collection<String> organismsLower = new ArrayList<String>();
    private InterMineBag bag;
    private static final Logger LOG = Logger.getLogger(GeneToDiseasePublicationLdr.class);
    private Model model;
     ...
     */
    public GeneToDiseasePublicationLdr(InterMineBag bag, ObjectStore os, String extraAttribute) {
    	LOG.error("HERE!");
        this.bag = bag;
    }
    ...
    public Query getQuery(String action, List<String> keys) {
        ...
        QueryCollectionReference fin = new QueryCollectionReference(qcDisease, "associatedPublications");
