 ...
 */
public class GeneToDiseasePublicationURLQuery implements WidgetURLQuery
{
    //private static final Logger LOG = Logger.getLogger(GeneToDiseasePublicationURLQuery.class);
     ...
     */
    public GeneToDiseasePublicationURLQuery(ObjectStore os, InterMineBag bag, String key) {
        this.bag = bag;
        this.key = key;
        this.os = os;
    }
    ...
    public PathQuery generatePathQuery() {
        ...
        q.setOrderBy("Gene.diseases.diseaseId, Gene.primaryIdentifier");
