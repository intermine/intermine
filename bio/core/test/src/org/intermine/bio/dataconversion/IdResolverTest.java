...
public class IdResolverTest extends TestCase
{
    ...
    protected void setUp() throws Exception {
        ...
        resolver.addMainIds("101", "Gene1", new HashSet(Arrays.asList(new String[] {"G1", "g1"})));
        resolver.addSynonyms("101", "Gene1", new HashSet(Arrays.asList(new String[] {"syn1", "syn2"})));
        resolver.addSynonyms("101", "Gene2", new HashSet(Arrays.asList(new String[] {"syn3"})));
    }
