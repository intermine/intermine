 ...
 *
 */
public class GAFQueryServlet extends HttpServlet
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(GAFQueryServlet.class);
    ...
    private void runService(HttpServletRequest request,
        ...
        new GAFQueryService(im).service(request, response);
    }
}
