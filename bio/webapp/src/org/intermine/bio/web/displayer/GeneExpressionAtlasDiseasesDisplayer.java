...
import org.intermine.bio.web.model.GeneExpressionAtlasDiseasesExpressions;
 ...
 *
 */
public class GeneExpressionAtlasDiseasesDisplayer extends ReportDisplayer
{
     ...
     * @param im .
     */
    public GeneExpressionAtlasDiseasesDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
    ...
    public void display(HttpServletRequest request, ReportObject reportObject) {
        ...
        if (genePrimaryIDObj != null) {
            ...
            // convert to a map
            GeneExpressionAtlasDiseasesExpressions geae = new GeneExpressionAtlasDiseasesExpressions(values);
