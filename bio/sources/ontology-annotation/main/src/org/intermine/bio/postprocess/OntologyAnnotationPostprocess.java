 ...
 */
public class OntologyAnnotationPostprocess extends PostProcessor
{
    private static final Logger LOG = Logger.getLogger(OntologyAnnotationPostprocess.class);
     ...
     */
    public OntologyAnnotationPostprocess(ObjectStoreWriter osw) {
        super(osw);
