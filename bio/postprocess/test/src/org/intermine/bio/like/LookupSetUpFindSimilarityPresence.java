 ...
 *
 */
public class LookupSetUpFindSimilarityPresence
{
    /**
     *
     * @throws IOException
...
//        File file1 = new File("matrix" + 3);
//        FileInputStream f1 = new FileInputStream(file1);
//        ObjectInputStream s1 = new ObjectInputStream(f1);
//        Map<Pair,Integer> matrix = (HashMap<Pair,Integer>)s1.readObject();
//        s1.close();
    ...
    //    long t1 = System.currentTimeMillis();
        Map<Coordinates, Integer> res = LookupFindSimilarityPresence.
                findSimilarityPresence(smallMatrix);
...
//        File file = new File("SimilarityMatrix" + 3);
