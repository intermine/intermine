...
public class LookupSetUpBuildMatrixColumns {
    ...
    //    long t1 = System.currentTimeMillis();
        Map<Coordinates,Integer> res = LookupCountCommonItemsCategory.countCommonItemsCategory(matrix);

        int latestColumn = LookupBuildMatrixColumns.buildMatrixColumns(Map<Coordinates, Integer> matrix, int currentRow,
