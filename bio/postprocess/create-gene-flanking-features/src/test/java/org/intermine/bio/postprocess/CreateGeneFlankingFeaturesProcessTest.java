...
public class CreateGeneFlankingFeaturesProcessTest extends TestCase {

    private ObjectStoreWriter osw;


    public CreateGeneFlankingFeaturesProcessTest(String arg) {
        super(arg);
    }
    ...
    public void testCreateFlankingFeatures() throws Exception {
        CreateGeneFlankingFeaturesProcess cfr = new CreateGeneFlankingFeaturesProcess(osw);
        cfr.postProcess();
