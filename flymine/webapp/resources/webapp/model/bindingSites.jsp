...
<TABLE width="100%">
  <TR>
    ...
    <TD valign="top">
      ...
      <div class="body">
        <DL>
          <DT>Regulatory elements: <I>D. melanogaster</I></DT>
          <DD>
            ...
            These data have been reported in Gallo, Li, Hu and Halfon (2006)
            Bioinformatics 22:381-383 (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids=16303794">PubMed: 16303794 </A>).
           </DD>
          ...
          <DD>
            ...
            These data have been reported in Bergman, Carlson and Celniker (2005)
