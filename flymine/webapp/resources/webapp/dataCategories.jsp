...
<table padding="0px" margin="0px" width="100%" table border="1" class='dbsources'>
 ...
 <tbody>
  ...
  <tr><th rowspan="5">  
    ...
    <td> (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids=">PubMed:</a>)</td> 
    <td> &nbsp;</td>
  </tr>
  ...
  <tr><th rowspan="1">
    ...
    <td> <a href="http://http://inparanoid.sbc.su.se/">InParanoid</a> - Version 5.1</td>
    <td>   (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids= ">PubMed:  </a>)</td> 
    <td>(1)</td>
  </tr>
  ...
  <tr><th rowspan="8">
    ...
    <td> <a href="http://www.ebi.uniprot.org/index.shtml">UniProt</a> - Release 11.0</td>
    <td>   (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids= ">PubMed:  </a>)</td> 
    <td> &nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td> <a href="http://www.ebi.ac.uk/interpro">InterPro</a> - Release 12.0</td>
    <td>   (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids= ">PubMed:  </a>)</td> 
    <td> &nbsp;</td>
  </tr>
  ...
  <tr><th rowspan="2">
    ...
    <td> D. melanogaster </td>
    <td> Ten high-throughput cell-based RNAi screens</td>
  ...
  <tr>
    <td> C. elegans </td>
    <td> RNAi phenotypes</td>
    <td> <a href="http://www.wormbase.org">WormBase</a> - 30th September 2006</td>
    <th>PubMedID</th>     <td>   (<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=PubMed&dopt=Abstract&list_uids= ">PubMed:  </a>)</td> 
    <td> &nbsp;</td>
  </tr>
