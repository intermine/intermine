 ...
 */
public class QueryBuilderPlugin1 implements QueryBuilderPlugin
{
    private static final Logger LOG = Logger.getLogger(QueryBuilderPlugin1.class);
    ...
    public JComponent buildUserInterface() {
        ...
        sp.setName("ortholog information");
        JPanel panel = new JPanel(new GridBagLayout());

        GridBagConstraints c = new GridBagConstraints();
        
        JLabel text1 = new JLabel("<html><b>Fetch ortholog information</b></html>");
        ...
        JLabel text2 = new JLabel("<html>For all selected Nodes<br>" 
                + "get orthologs from organism:</html>");
...
//        JList pubList = new JList(new Vector(10));
...
//        JButton run1Button = new JButton(new UI1Action(this, "append network", pubList, false));
//        c.weighty = 0;
//        c.fill = 0;
//        c.anchor = GridBagConstraints.WEST;
...
//
//        JButton run2Button = new JButton(new UI1Action(this, "new network", pubList, true));
//        c.anchor = GridBagConstraints.EAST;
...
//
//    /**
//     * @param pubMedId the pubMedID to 
...
////        if (res != null) {
////            LOG.debug("result has following elements:");
////            for (Iterator iter = res.iterator(); iter.hasNext();) {
////                //ProteinInteraction element = (ProteinInteraction) iter.next();
...
////        }
//        
//        return createFlyNetwork(res, pubMedId);
//        
//    }
//    
//    /**
...
//                    FlyEdge fe = new FlyEdge(prey, bait); // use default edge type
//
//                    fe.setAttribute("pubMedId_LIST", pubMedId, FlyValueWrapper.COUNT);
//                    fe.setAttribute("pubMedId_TEST", pubMedId, FlyValueWrapper.COUNT);
////                    fe.setAttribute("pubMedId_COUNT", new Integer(1), FlyValueWrapper.COUNT);
//                    
//                    fn.addNode(prey);
//                    fn.addNode(bait);
//                    fn.addEdge(fe);
...
//                            fe.setAttribute("pubMedId_LIST", pubMedId, FlyValueWrapper.COUNT);
//                            fe.setAttribute("pubMedId_TEST", pubMedId, FlyValueWrapper.COUNT);
////                            ex.setAttribute("pubMedId_COUNT", new Integer(1), 
////                                    FlyValueWrapper.COUNT);
//
//                            fn.addEdge(fe);
//                        }
//                    }
