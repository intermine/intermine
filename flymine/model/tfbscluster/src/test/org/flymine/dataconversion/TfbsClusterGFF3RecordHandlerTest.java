...
/**
 * Tests for the TfbsClusterGFF3RecordHandler class.
 *
 * @author Wenyan Ji
 */

public class TfbsClusterGFF3RecordHandlerTest extends TestCase
{
    TfbsClusterGFF3RecordHandler handler;
    ...
    public void testParse() throws Exception {
        BufferedReader srcReader = new BufferedReader(new
                   InputStreamReader(getClass().getClassLoader().getResourceAsStream("test/ClusterTest.gff")));
        converter.parse(srcReader);
        converter.store();

        FileWriter writerSrc = new FileWriter(new File("cluster_items.xml"));
    ...
    protected Collection getExpectedItems() throws Exception {
        return FullParser.parse(getClass().getClassLoader().getResourceAsStream("test/ClusterTgt.xml"));
    }
