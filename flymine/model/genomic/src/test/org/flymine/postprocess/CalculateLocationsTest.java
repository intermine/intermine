...
public class CalculateLocationsTest extends TestCase {
    ...
    public void testContigToSupercontig() throws Exception {
        ...
        Location scOnChr = createLocation(getChromosome(), sc, 0, 1200, 1600);
        Location contigOnSc = createLocation(sc, c, 0, 100, 350);
        toStore.add(sc);
        toStore.add(c);
        toStore.add(scOnChr);
        ...
        Location expected = createLocation(getChromosome(), c, 0, 1300, 1550);
        expected.setId(new Integer(0));
        Item expItem = FullRenderer.toItem(expected, model);
        ...
        expected = createLocation(getChromosomeBand(), c, 0, 300, 550);
        expected.setId(new Integer(0));
    ...
    public void testFeatureToContig() throws Exception {
        ...
        Location scOnChr = createLocation(getChromosome(), sc, 0, 1200, 1600);
        Location contigOnSc = createLocation(sc, c, 0, 100, 350);
        Location exonOnContig = createLocation(c, e, 0, 50, 150);
        toStore.add(sc);
        toStore.add(c);
        toStore.add(e);
        toStore.add(scOnChr);
        ...
        Location expected = createLocation(getChromosome(), e, 0, 1350, 1450);
        expected.setId(new Integer(0));
        Item expItem = FullRenderer.toItem(expected, model);
        ...
        expected = createLocation(getChromosomeBand(), e, 0, 350, 450);
        expected.setId(new Integer(0));
        expItem = FullRenderer.toItem(expected, model);
    ...
    public void testOverlap() throws Exception {
        CalculateLocations cl = new CalculateLocations(osw);
        CalculateLocations.SimpleLoc parent = cl.new SimpleLoc(101, 102, 100, 200, 0);

        //   ------------       parent
        //          |
        //          ---------   child
        CalculateLocations.SimpleLoc s1 = cl.new SimpleLoc(101, 103, 150, 250, 0);
        ...
        //            |
        //   ----------          child
        CalculateLocations.SimpleLoc s2 = cl.new SimpleLoc(101, 103, 50, 150, 0);
        ...
        //      |        |
        //      ----------      child
        CalculateLocations.SimpleLoc s3 = cl.new SimpleLoc(101, 103, 125, 175, 0);
        ...
        //      |      |
        //   --------------    child
        CalculateLocations.SimpleLoc s4 = cl.new SimpleLoc(101, 103, 50, 250, 0);
        ...
        //
        //          -------    child
        CalculateLocations.SimpleLoc s5 = cl.new SimpleLoc(101, 103, 250, 350, 0);
        ...
        //
        // -------             child
        CalculateLocations.SimpleLoc s6 = cl.new SimpleLoc(101, 103, 25, 75, 0);
    ...
    public void testCreateLocation() throws Exception {
        ...
        //          ---------   child
        CalculateLocations cl = new CalculateLocations(osw);
        CalculateLocations.SimpleLoc parentOnChr = cl.new SimpleLoc(parentId, childId, 100, 300, 0);
        CalculateLocations.SimpleLoc childOnChr = cl.new SimpleLoc(parentId, childId, 250, 450, 0);
        ...
        exp1.setStart(new Integer(150));
        exp1.setEnd(new Integer(200));
        exp1.setStartIsPartial(Boolean.FALSE);
        exp1.setEndIsPartial(Boolean.TRUE);
        exp1.setSubjectStart(new Integer(0));
        exp1.setSubjectEnd(new Integer(50));
        ...
        exp2.setSubjectStart(new Integer(50));
        ...
        //      ----------      child
        cl = new CalculateLocations(osw);
        parentOnChr = cl.new SimpleLoc(parentId, childId, 100, 300, 1);
        childOnChr = cl.new SimpleLoc(parentId, childId, 150, 250, -1);
        res = cl.createLocation(parent, parentOnChr, child, childOnChr);

        Location exp3 = (Location) DynamicUtil.createObject(Collections.singleton(Location.class));
        exp3.setStart(new Integer(50));
...
//     }
    ...
    private Location getBandOnChr() {
        if (bandOnChr == null) {
            ...
            bandOnChr.setStart(new Integer(1000));
