drop database ensembl_hs_small;
create database ensembl_hs_small;

USE ensembl_hs_small;

create table coord_system as select * from homo_sapiens_core_37_35j.coord_system;
create table meta_coord as select * from homo_sapiens_core_37_35j.meta_coord;

--Get some suitable seq_region_id's - i.e. Chromosomes...
create table gene_seq_region_id as select seq_region_id from (
    select seq_region_id from homo_sapiens_core_37_35j.seq_region
    where coord_system_id = 1 and name like '21'
) bob LIMIT 1;
create index idx_gsrid_sr_id on gene_seq_region_id(seq_region_id);

create table gene as select * from homo_sapiens_core_37_35j.gene
...
create table karyotype as select * from homo_sapiens_core_37_35j.karyotype
where seq_region_id in (select distinct seq_region_id from gene);
create index idx_k_id on karyotype(karyotype_id);

create table transcript as select * from homo_sapiens_core_37_35j.transcript
...
create table exon_transcript as select * from homo_sapiens_core_37_35j.exon_transcript
...
create table seq_region as select * from homo_sapiens_core_37_35j.seq_region limit 0;
//##Insert the rows related to the gene table (transcript and exon share the same seq_regions...)
insert into seq_region select * from homo_sapiens_core_37_35j.seq_region
where seq_region_id in (select distinct seq_region_id from gene);

--#Make the assembly table that maps the chromosomes(groups) to contigs(chunks)
create table assembly as select * from homo_sapiens_core_37_35j.assembly
...
create table simple_feature as select * from homo_sapiens_core_37_35j.simple_feature
...
create table repeat_consensus as select * from homo_sapiens_core_37_35j.repeat_consensus
...
create table marker_feature as select * from homo_sapiens_core_37_35j.marker_feature
where seq_region_id in (select seq_region_id from seq_region);

create table marker as select * from homo_sapiens_core_37_35j.marker
where marker_id in (select marker_id from marker_feature);

create table marker_synonym as select * from homo_sapiens_core_37_35j.marker_synonym
where marker_synonym_id in (select display_marker_synonym_id from marker);

create table exon_stable_id as select * from homo_sapiens_core_37_35j.exon_stable_id
...
create table gene_stable_id as select * from homo_sapiens_core_37_35j.gene_stable_id
where gene_id in (select gene_id from gene);
create index idx_gsid_e_id on gene_stable_id(gene_id);
create index idx_gsid_s_id on gene_stable_id(stable_id);

create table transcript_stable_id as select * from homo_sapiens_core_37_35j.transcript_stable_id
where transcript_id in (select transcript_id from transcript);
...
create table translation_stable_id as select * from homo_sapiens_core_37_35j.translation_stable_id
...
create table analysis as select * from homo_sapiens_core_37_35j.analysis;
create index idx_a_id on analysis(analysis_id);

create table analysis_description as select * from homo_sapiens_core_37_35j.analysis_description
where analysis_id in (select analysis_id from analysis);
create index idx_ad_a_id on analysis_description(analysis_id);

create table dna as select * from homo_sapiens_core_37_35j.dna
where seq_region_id in (select seq_region_id from seq_region);
create index idx_d_sr_id on dna(seq_region_id);

--CREATE SOME EMPTY TABLES--
create table qtl_synonym as select * from homo_sapiens_core_37_35j.qtl_synonym limit 0;
create table qtl as select * from homo_sapiens_core_37_35j.qtl limit 0;
create table qtl_feature as select * from homo_sapiens_core_37_35j.qtl_feature limit 0;
create table alt_allele as select * from homo_sapiens_core_37_35j.alt_allele limit 0;
create table seq_region_attrib as select * from homo_sapiens_core_37_35j.seq_region_attrib limit 0;
create table translation_attrib as select * from homo_sapiens_core_37_35j.translation_attrib limit 0;
create table transcript_attrib as select * from homo_sapiens_core_37_35j.transcript_attrib limit 0;
create table attrib_type as select * from homo_sapiens_core_37_35j.attrib_type limit 0;
create table misc_attrib as select * from homo_sapiens_core_37_35j.misc_attrib limit 0;
create table misc_feature as select * from homo_sapiens_core_37_35j.misc_feature limit 0;
create table misc_feature_misc_set as select * from homo_sapiens_core_37_35j.misc_feature_misc_set limit 0;
create table misc_set as select * from homo_sapiens_core_37_35j.misc_set limit 0;
create table map as select * from homo_sapiens_core_37_35j.map limit 0;
create table marker_map_location as select * from homo_sapiens_core_37_35j.marker_map_location limit 0;
create table assembly_exception as select * from homo_sapiens_core_37_35j.assembly_exception limit 0;
