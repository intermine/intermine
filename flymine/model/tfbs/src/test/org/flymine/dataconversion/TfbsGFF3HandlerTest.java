...
/**
 * Tests for the TfbsGFF3Handler class.
 *
 * @author Wenyan Ji
 */

public class TfbsGFF3HandlerTest extends TestCase
{
    TfbsGFF3RecordHandler handler;
    ...
    String dataSetTitle = "UCSC transcription factor binding sites";

    public void setUp() throws Exception {
        Model tgtModel = Model.getInstanceByName("genomic");
        handler = new TfbsGFF3RecordHandler(tgtModel);
    ...
    protected Collection getExpectedItems() throws Exception {
        return FullParser.parse(getClass().getClassLoader().getResourceAsStream("test/tfbstgt.xml"));
    }
