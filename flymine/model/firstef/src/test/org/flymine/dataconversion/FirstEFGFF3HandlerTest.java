...
public class FirstEFGFF3HandlerTest extends TestCase
{
    FirstEFGFF3RecordHandler handler;
    ...
    String dataSetTitle = "UCSC FirstEF data set";
    
    public void setUp() throws Exception {
        Model tgtModel = Model.getInstanceByName("genomic");
        handler = new FirstEFGFF3RecordHandler(tgtModel);
    ...
    protected Collection getExpectedItems() throws Exception {
        return FullParser.parse(getClass().getClassLoader().getResourceAsStream("test/firsteftgt.xml"));
    }
