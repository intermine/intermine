<%--
  ...
  - Description: In this page, the fly regulatory network will be
...
<script type="text/javascript" src="<html:rewrite page='/model/cytoscape/fly_regulatory_network.js'/>"></script>
<script type="text/javascript">

    var classMissingMessage = '${classMissingMessage}';
    var flyRegulatoryNetwork = '${flyRegulatoryNetwork}';
