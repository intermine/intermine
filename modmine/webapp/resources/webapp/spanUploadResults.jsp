            ...
            if (features == null) {
                ...
                if (resultToDisplay[i].gbrowseurl != null) {
                    if(resultToDisplay[i].organism == "D. melanogaster") {
                        if (features[0].featurePId.length > 50 && features[0].subTitle.length > 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><a title='Some submissions may not have tracks' target='_blank' href='${GBROWSE_BASE_URL}fly/?label="+resultToDisplay[i].gbrowseurl+"'>GBrowse tracks</a><img border='0' title='fly' src='model/images/fly_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId.substring(0,50) + "...</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle.substring(0,50) + "...</td></tr>");
                        }

                        if (features[0].featurePId.length > 50 && features[0].subTitle.length <= 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><a title='Some submissions may not have tracks' target='_blank' href='${GBROWSE_BASE_URL}fly/?label="+resultToDisplay[i].gbrowseurl+"'>GBrowse tracks</a><img border='0' title='fly' src='model/images/fly_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId.substring(0,50) + "...</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle + "</td></tr>");
                        }

                        if (features[0].featurePId.length <= 50 && features[0].subTitle.length > 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><a title='Some submissions may not have tracks' target='_blank' href='${GBROWSE_BASE_URL}fly/?label="+resultToDisplay[i].gbrowseurl+"'>GBrowse tracks</a><img border='0' title='fly' src='model/images/fly_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId + "</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle.substring(0,50) + "...</td></tr>");
                        }

                        if (features[0].featurePId.length <= 50 && features[0].subTitle.length <= 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><a title='Some submissions may not have tracks' target='_blank' href='${GBROWSE_BASE_URL}fly/?label="+resultToDisplay[i].gbrowseurl+"'>GBrowse tracks</a><img border='0' title='fly' src='model/images/fly_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId + "</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle + "</td></tr>");
                        }
                    }
                    else if (resultToDisplay[i].organism == "C. elegans") {
                        if (features[0].featurePId.length > 50 && features[0].subTitle.length > 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><a title='Some submissions may not have tracks' target='_blank' href='${GBROWSE_BASE_URL}worm/?label="+resultToDisplay[i].gbrowseurl+"'>GBrowse tracks</a><img border='0' title='worm' src='model/images/worm_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId.substring(0,50) + "...</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle.substring(0,50) + "...</td></tr>");
                        }
                    ...
                    if(resultToDisplay[i].organism == "D. melanogaster") {
                        ...
                        if (features[0].featurePId.length > 50 && features[0].subTitle.length > 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><span style='color:grey;' title='No tracks available'>GBrowse tracks</span><img border='0' title='worm' src='model/images/worm_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div><div style='align:center'><a href='javascript: exportToGalaxy(\""+resultToDisplay[i].span+"\");' class='ext_link'> Export to Galaxy </a><img border='0' title='Export to Galaxy' src='model/images/Galaxy_logo_small.png' class='arrow' style='height:13%; width:13%'></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId.substring(0,50) + "...</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle.substring(0,50) + "...</td></tr>");
                        }

                        if (features[0].featurePId.length > 50 && features[0].subTitle.length <= 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><span style='color:grey;' title='No tracks available'>GBrowse tracks</span><img border='0' title='worm' src='model/images/worm_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div><div style='align:center'><a href='javascript: exportToGalaxy(\""+resultToDisplay[i].span+"\");' class='ext_link'> Export to Galaxy </a><img border='0' title='Export to Galaxy' src='model/images/Galaxy_logo_small.png' class='arrow' style='height:13%; width:13%'></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId.substring(0,50) + "...</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle + "</td></tr>");
                        }

                        if (features[0].featurePId.length <= 50 && features[0].subTitle.length > 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><span style='color:grey;' title='No tracks available'>GBrowse tracks</span><img border='0' title='worm' src='model/images/worm_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div><div style='align:center'><a href='javascript: exportToGalaxy(\""+resultToDisplay[i].span+"\");' class='ext_link'> Export to Galaxy </a><img border='0' title='Export to Galaxy' src='model/images/Galaxy_logo_small.png' class='arrow' style='height:13%; width:13%'></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId + "</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle.substring(0,50) + "...</td></tr>");
                        }

                        if (features[0].featurePId.length <= 50 && features[0].subTitle.length <= 50) {
                            jQuery("#spanResultsTable > tbody").append("<tr><td valign='top' rowspan='"+features.length+"'><b>"+resultToDisplay[i].span+"</b><br><div style='align:center'><span style='color:grey;' title='No tracks available'>GBrowse tracks</span><img border='0' title='worm' src='model/images/worm_gb.png' class='arrow'></div><div style='align:center; padding-bottom:12px'><span class='fakelink exportDiv'> Export data </span><img class='exportDiv' style='position:relative; top:3px;' border='0' src='model/images/download.png' title='export data' height='18' width='18'/><ul class='contextMenu'><li class='tab'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"tab\");' class='ext_link'>TAB</a></li><li class='csv'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"csv\");' class='ext_link'>CSV</a></li><li class='gff'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"gff3\");' class='ext_link'>GFF3</a></li><li class='seq'><a href='#javascript: exportFeatures(\""+resultToDisplay[i].span+"\", \"sequence\");' class='ext_link'>SEQ</a></li></ul></div><div style='align:center'><a href='javascript: exportToGalaxy(\""+resultToDisplay[i].span+"\");' class='ext_link'> Export to Galaxy </a><img border='0' title='Export to Galaxy' src='model/images/Galaxy_logo_small.png' class='arrow' style='height:13%; width:13%'></div></td><td><a target='_blank' title='" + features[0].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].featurePId + "&class=" + features[0].featureType + "'>" + features[0].featurePId + "</a></td><td>"+features[0].featureType+"</td><td>"+features[0].location+"</td><td>"+features[0].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[0].dccId + "&class=Submission'>" + features[0].dccId + "</a></td><td>" + features[0].subTitle + "</td></tr>");
                        }
                    }
                }
                ...
                for (j=1; j<features.length; j++) {
                    if (features[j].featurePId.length > 50 && features[j].subTitle.length > 50) {
                        jQuery("#spanResultsTable > tbody").append("<tr><td><a target='_blank' title='" + features[j].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[j].featurePId + "&class=" + features[j].featureType + "'>" + features[j].featurePId.substring(0,50) + "...</a></td><td>"+features[j].featureType+"</td><td>"+features[j].location+"</td><td>"+features[j].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[j].dccId + "&class=Submission'>" + features[j].dccId + "</a></td><td>" + features[j].subTitle.substring(0,50) + "...</td></tr>");
                    }
                    ...
                    if (features[j].featurePId.length <= 50 && features[j].subTitle.length > 50) {
                        jQuery("#spanResultsTable > tbody").append("<tr><td><a target='_blank' title='" + features[j].featurePId + "' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[j].featurePId + "&class=" + features[j].featureType + "'>" + features[j].featurePId + "</a></td><td>"+features[j].featureType+"</td><td>"+features[j].location+"</td><td>"+features[j].machedBaseCount+"</td><td><a target='_blank' href='" + "${WEB_PROPERTIES['webapp.baseurl']}/${WEB_PROPERTIES['webapp.path']}" + "/portal.do?externalid=" + features[j].dccId + "&class=Submission'>" + features[j].dccId + "</a></td><td>" + features[j].subTitle.substring(0,50) + "...</td></tr>");
                    }
