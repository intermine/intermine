      ...
      <div class="center span-11 last">
        <div class="bochs" id="bochs-1">
            <div id="thumb" class="span-4">
                <img src="themes/modmine/icons/chromatin-structure.png" alt="experiments View"/>
            </div>
            <div id="welcome-content" class="span-7 last current">
              <h2>Welcome to modMine</h2>
              <p><strong>modMine</strong> is an integrated web resource of Data &amp; Tools to support the modENCODE research community.</p>
<p>The data generated by modENCODE fall into several categories based on the genomic or biological
element tested (e.g. Gene Structure, ncRNA Expression Profiling, DNA Replication, etc.).
 Each category contains multiple sets of experiments, with each set varying by the assay method,
submitting group, and/or experimental condition tested.  
An individual 'submission' is a single instance of an experiment which tests varying factors,
such as life stage, genetic background, or antibody, and consists of a package of results,
 experimental protocols and other metadata.</p>
...
<br />
   ...
   <div id="bochs" class="span-4 last">
     ...
     <div class="text">
       <p>Search for genomic features in a given region of the genome.
       </p>
     </div>
   </div>
