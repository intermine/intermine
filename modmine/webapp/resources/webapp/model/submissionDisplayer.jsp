...
Find        <html:select styleId="typeSelector" property="overlapFindType">
          ...
          <html:option value="Exon">Exon</html:option>
          <html:option value="Intron">Intron</html:option>
          <html:option value="IntergenicRegion">IntergenicRegion</html:option>
        </html:select>
features which overlap the
    ...
    <html:submit styleId="submitBag" property="overlaps">submit</html:submit>


       <br />

    Find genes where features generated by this submission fall within:    
    ...
    <html:submit styleId="submitBag" property="flanking">submit</html:submit>
