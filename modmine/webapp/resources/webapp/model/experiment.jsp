...
Expression Levels
  ...
  <html:link
    href="/${WEB_PROPERTIES['webapp.path']}/features.do?type=expEL&action=results&experiment=${exp.name}&feature=${fc.key}"
        title="View all expression levels for these ${fc.key}s">${expELF.value}
              <html:img src="images/right-arrow.gif" title="View all expression levels for these ${fc.key}s" /></html:link>
