...
<%--TODO use featureaction! find icon for expression levels --%>
...
<c:forEach items="${expFeatEL}" var="expEL" varStatus="expEL_status">
  ...
  <c:forEach items="${expEL.value}" var="expELF" varStatus="expELF_status">
    <c:if test="${expELF.key == fc.key}" >
Expression Levels
<im:querylink text="${expELF.value}" showArrow="true" skipBuilder="true">
<query name="" model="genomic" view="ExpressionLevel.name ExpressionLevel.value ExpressionLevel.readCount ExpressionLevel.dcpm ExpressionLevel.dcpmBases ExpressionLevel.transcribed ExpressionLevel.predictionStatus" sortOrder="ExpressionLevel.name asc" constraintLogic="A and B">
  <node path="ExpressionLevel" type="ExpressionLevel">
  </node>
  <node path="ExpressionLevel.feature" type="LocatedSequenceFeature">
  </node>
  <node path="ExpressionLevel.feature.featureType" type="String">
    <constraint op="=" value="${fc.key}" description="" identifier="" code="A">
    </constraint>
  </node>
  <node path="ExpressionLevel.submission" type="Submission">
  </node>
  <node path="ExpressionLevel.submission.experiment" type="Experiment">
  </node>
  <node path="ExpressionLevel.submission.experiment.name" type="String">
    <constraint op="=" value="${exp.name}" description="" identifier="" code="B">
    </constraint>
  </node>
</query>
</im:querylink>
...
Expression Levels:&nbsp;
<im:querylink text="${subELF.value}" showArrow="false" skipBuilder="true">
<query name="" model="genomic" view="ExpressionLevel.name ExpressionLevel.value ExpressionLevel.readCount ExpressionLevel.dcpm ExpressionLevel.dcpmBases ExpressionLevel.transcribed ExpressionLevel.predictionStatus" sortOrder="ExpressionLevel.name asc" constraintLogic="A and B">
  <node path="ExpressionLevel" type="ExpressionLevel">
  </node>
  <node path="ExpressionLevel.feature" type="LocatedSequenceFeature">
  ...
  <node path="ExpressionLevel.submission.DCCid" type="Integer">
    <constraint op="=" value="${sub.dCCid}" description="" identifier="" code="B">
    </constraint>
  </node>
</query>
</im:querylink>
