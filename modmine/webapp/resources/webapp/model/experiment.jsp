...
--%>
      ...
      <c:forEach items="${exp.featureCounts}" var="fc" varStatus="status">
          <tr>
            ...
            <td align="center">
              <html:link
        href="/${WEB_PROPERTIES['webapp.path']}/features.do?type=experiment&action=results&experiment=${exp.name}&feature=${fc.key}">${fc.value}
              <html:img src="images/right-arrow.gif" title="View all features in tabular format" />
