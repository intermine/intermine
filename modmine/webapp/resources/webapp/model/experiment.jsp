...
All features generated by this experiment:
      ...
      <c:forEach items="${exp.featureCounts}" var="fc" varStatus="status">
        ...
        title="View all these features">${fc.value}
              <html:img src="images/right-arrow.gif" title="View all these features" /></html:link>
            </td>
...
<tr>
<td ><b><html:link 
     href="${baseUrl}fly/?label=${urlabels}" target="_blank" title="View all the tracks for this experiment">
...
<tr>
<td><b><html:link
     href="${baseUrl}worm/?label=${urlabels}" target="_blank" title="View all the tracks for this experiment">
     All ${fn:length(tracks[exp.name])} tracks
</html:link></b></td>
<td>
