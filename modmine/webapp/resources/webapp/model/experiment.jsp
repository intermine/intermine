...
<b><html:link 
     href="${baseUrl}${organism}/?label=${urlabels}" target="_blank" title="View all the tracks for this experiment">
...
<c:if test="${fn:length(tracks[exp.name]) == 1}">
<b><html:link 
     href="${baseUrl}${organism}/?label=${urlabels}" target="_blank" title="View the track generated for this experiment">
     ${urlabels}
</html:link></b>
</c:if>
