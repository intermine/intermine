...
<%--
          <li>
            <im:querylink text="Orthologues: <i>D. melanogaster</i> vs <i>A. gambiae</i> " skipBuilder="true">
             <query name="" model="genomic" view="Orthologue.gene.identifier Orthologue.gene.primaryIdentifier Orthologue.gene.symbol Orthologue.orthologue.identifier Orthologue.orthologue.primaryIdentifier Orthologue.orthologue.symbol" constraintLogic="C and A">
