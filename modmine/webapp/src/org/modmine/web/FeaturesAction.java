...
public class FeaturesAction extends InterMineAction
{
    ...
    throws Exception {
        ...
        if (type.equals("experiment")) {
            ...
            + ". Experimental factors are the " + StringUtil.prettyList(exp.getFactorTypes()) 
            + " used (" + exp.getPi() + ").";
            ...
            String description = "All " + featureType + " features generated by submission " + dccId
                + ", " + experimentType + " "
                + sub.getOrganism().getShortName() + " using " 
                + SubmissionHelper.getExperimentalFactorString(sub)
