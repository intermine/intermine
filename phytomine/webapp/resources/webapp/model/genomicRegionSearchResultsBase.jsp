...
<!-- if a 'Chromosome' is desired, we're downloading FASTA. Get rid of the other stuff -->
var featureTypes = "<%= request.getParameter("featureTypes") %>";
if (featureTypes == "Chromosome" ) {
   jQuery("#resultDiv").remove();
   jQuery.download("genomicRegionSearchAjax.do", "exportFeatures=true&spanUUIDString=" + span_uuid_string + "&criteria=all&facet=&format=chrSeg");
}
</script>
