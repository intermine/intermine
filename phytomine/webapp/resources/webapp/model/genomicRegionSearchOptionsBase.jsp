              ...
              <div class="body">
                <html:form action="/genomicRegionSearchAction" method="POST" enctype="multipart/form-data">
                  ...
                  <div align="right">
                     ...
                     <!-- clear out all selected featureTypes and append featureTypes=Chromosom hidden parameter -->
                     <input type="button" onclick="javascript: if(validateBeforeSubmit()) { jQuery(':input[name=\'featureTypes\']').remove(); jQuery('form#genomicRegionSearchForm').append(jQuery('<input>').attr('type','hidden').attr('name','featureTypes').attr('value','Chromosome')).submit();}" value="Genomic FASTA" />
