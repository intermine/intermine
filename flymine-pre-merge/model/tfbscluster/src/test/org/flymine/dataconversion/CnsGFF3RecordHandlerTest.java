...
/**
 * Tests for the CnsGFF3RecordHandler class.
 *
 * @author Wenyan Ji
 */

public class CnsGFF3RecordHandlerTest extends TestCase
{
    CnsGFF3RecordHandler handler;
    ...
    String dataSetTitle = "HSCL conserved non-coding sites";
    
    public void setUp() throws Exception {
        Model tgtModel = Model.getInstanceByName("genomic");
        handler = new CnsGFF3RecordHandler(tgtModel);
    ...
    protected Collection getExpectedItems() throws Exception {
        return FullParser.parse(getClass().getClassLoader().getResourceAsStream("test/CnsTgt.xml"));
    }
