...
<ul>
  <li>
    ...
    <div id="prerequisite" style="padding: 5px">
      <p>
        You should install the <a href="http://search.cpan.org/~intermine/Webservice-InterMine/lib/Webservice/InterMine.pm">
        ...
        <br><br>
            ...
            of Perl modules can be found <a href="http://www.intermine.org/wiki/InstallingPerlModules">here</a>.
      </p>
    </div>
  </li>
  <li>
    ...
    springboards to help you get where you want to. See the <a href="http://search.cpan.org/~intermine/Webservice-InterMine/lib/Webservice/InterMine/Cookbook.pod">Cookbook</a>
    ...
    <p>
    For a good reference to writing programs in Perl, see <a href="http://www.onyxneon.com/books/modern_perl/index.html">here</a>.
    </p>
