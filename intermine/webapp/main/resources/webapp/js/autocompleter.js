    ...
    var FIELD;		  // field name from the table vor the lucene search
    ...
    // spezific function for submit in template
    function isEnter(e) { 
        var curKey;
    	if (e.which) {   			// FF
        	curKey = e.which;
	...
	// created a spezific cutted list of the long list
