  ...
  <c:if test="${fn:length(viewStrings) > 0}">
    ...
    <script type="text/javascript">
        ...
        Sortable.create('viewDivs', {
              tag:'div', dropOnEmpty:true,  constraint:'horizontal', overlap:'horizontal', 
              onUpdate:function() {
                  reorderOnServer();
              }
            });
        ...
        function reorderOnServer() {
            ...
            new Ajax.Request('<html:rewrite action="/viewChange"/>', {
                  parameters:'method=reorder&'+previousOrder+'&'+newOrder, asynchronous:true});
            recordCurrentOrder();
        }
        ...
        function reverseSortDirection() {
            ...
            new Ajax.Request('<html:rewrite action="/sortOrderChange"/>', {
                  parameters:'method=changeDirection&direction='+newDirection, asynchronous:true});
