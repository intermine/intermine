...
// Changes to support Java 5 generics:
/* 
 ...
 * Java 5 changes:
 * @author Kim Rutheford
 */
public class GenericCompositeMap<K,V> implements Map<K,V> {
     ...
     */
    public GenericCompositeMap(Map one, Map two) {
     ...
     */
    public GenericCompositeMap(Map one, Map two, MapMutator mutator) {
     ...
     * @throws IllegalArgumentException if there is a key collision
     */
    public GenericCompositeMap(Map[] composite) {
        this(composite, null);
    }
     ...
     * @param mutator  MapMutator to be used for mutation operations
     */
    public GenericCompositeMap(Map[] composite, MapMutator mutator) {
