...
public class DatabaseSchemaTest extends TestCase
{
    ...
    public void testInvalidTruncatedList() throws Exception {
        ...
        try {
            new DatabaseSchema(model, truncated, false, Collections.EMPTY_SET, 1, false, null);
    ...
    public void testValidTruncatedList() throws Exception {
        ...
        DatabaseSchema schema = new DatabaseSchema(model, truncated, false, Collections.EMPTY_SET, 1, false, null);
        ...
        schema = new DatabaseSchema(model, truncated, false, Collections.EMPTY_SET, 1, false, null);
    ...
    public void testValidTruncatedListFlatMode() throws Exception {
        ...
        truncated.add(manager);
        truncated.add(employee);
        DatabaseSchema schema = new DatabaseSchema(model, truncated, true, Collections.singleton("intermineobject"), 1, false, null);
        ...
        truncated.add(employee);
        truncated.add(importantPerson);
        schema = new DatabaseSchema(model, truncated, true, Collections.singleton("intermineobject"), 1, false, null);
