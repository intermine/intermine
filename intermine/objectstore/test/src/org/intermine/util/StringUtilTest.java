...
public class StringUtilTest extends TestCase
{
    ...
    public void testCollectionToString() throws Exception {
        {
            ...
            assertEquals(expected, StringUtil.collectionToString(testCollection, connector));
        }
        ...
        {
            String expected = "";
            assertEquals(expected, StringUtil.collectionToString(null, null));
        }
...

        {
            ...
            String expected = "abc 123 !$!%£^";
            assertEquals(expected, StringUtil.collectionToString(testCollection, null));
        }
    ...
    public void testArrayToString() throws Exception {
        {
            String[] testArray = {"abc", "123", "!$!%£^"};

            String connector = ",";

            String expected = "abc,123,!$!%£^";
            assertEquals(expected, StringUtil.arrayToString(testArray, connector));
        }
