...
/**
 * The FindTempaltesService is service for fetching template queries available in an InterMine
 * instance
 * 
 * @author Richard Smith
 **/
public class FindTemplatesService extends Service
{
     ...
     */
    public FindTemplatesService(String rootUrl, String applicationName) {
