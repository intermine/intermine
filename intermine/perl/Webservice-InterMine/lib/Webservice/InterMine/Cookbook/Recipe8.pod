...
InterMine::Cookbook::Recipe8 - Saving Queries
...
=head1 SYNOPSIS
  ...
  use InterMine ('www.flymine.org/query/service', $user, $pass);
  ...
  my $query = InterMine->saved_query('My First Saved Query');
...
L<InterMine::Cookbook::Templates::Recipe2>). As long as you have provided your login
