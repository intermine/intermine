...
If you use InterMine queries a lot, you may find yourself doing the same thing over
...
examine ways to extend InterMine to make it do what you want it to do.
