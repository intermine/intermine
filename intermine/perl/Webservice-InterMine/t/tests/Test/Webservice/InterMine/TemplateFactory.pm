...
sub get_templates : Test(2) {
    ...
    is(scalar(@templates), 13, "Gets the right number of templates");
    is($obj->_get_parsed_count, 13, "Getting templates means they get parsed");
}
...
sub get_template_by_name : Test(4) {
    ...
    is($obj->get_template_count, 13, "But all templates have been found");
