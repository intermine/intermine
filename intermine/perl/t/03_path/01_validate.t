...
my $parse      = InterMine::Path->can('_parse');
my $class_of   = InterMine::Path->can('class_of');
my $next_class = InterMine::Path->can('_next_class');
my $last_bit   = InterMine::Path->can('last_bit');
