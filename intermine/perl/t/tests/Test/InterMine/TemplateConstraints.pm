package Test::InterMine::TemplateConstraint;;

use base ('Test::InterMine::Constraint', 'Test::InterMine::Constraint::Roles::Templated');
...
package Test::InterMine::TemplateConstraint::Unary;

use base ('Test::InterMine::Constraint::Roles::Templated',
	  'Test::InterMine::Constraint::Unary',);
...
package Test::InterMine::TemplateConstraint::Binary;

use base (
    'Test::InterMine::Constraint::Binary',
    'Test::InterMine::Constraint::Roles::Templated'
);
################# START OF DUMB CUT AND PASTE SECTION
...
sub strict_construction : Test(47) {
    my $test = shift;
    $test->SUPER::strict_construction;
    $test->test_template_construction($test->SUPER::args);
}
...
package Test::InterMine::TemplateConstraint::Ternary;

use base (
    'Test::InterMine::Constraint::Ternary',
    'Test::InterMine::Constraint::Roles::Templated'
);
################# START OF DUMB CUT AND PASTE SECTION
...
package Test::InterMine::TemplateConstraint::Multi;

use base (
    'Test::InterMine::Constraint::Multi',
    'Test::InterMine::Constraint::Roles::Templated'
);
################# START OF DUMB CUT AND PASTE SECTION
...
package Test::InterMine::TemplateConstraint::SubClass;

use base (
    'Test::InterMine::Constraint::SubClass',
    'Test::InterMine::Constraint::Roles::Templated'
);
################# START OF DUMB CUT AND PASTE SECTION
