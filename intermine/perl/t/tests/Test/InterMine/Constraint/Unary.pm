package Test::InterMine::Constraint::Unary;
use base ('Test::InterMine::Constraint');
use Test::More;
use Test::Exception;

sub class {'InterMine::Constraint::Unary'};
sub hash {(
    path => 'Some.path.here',
    op   => 'IS NULL',
)}
...
sub inheritance : Test(4) {
    ...
    my $parent = 'InterMine::Constraint';
    my $role1   = 'InterMine::Constraint::Roles::Operator';
    my $role2   = 'InterMine::Roles::Logical';
