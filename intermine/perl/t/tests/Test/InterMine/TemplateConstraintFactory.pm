package Test::InterMine::TemplateConstraintFactory;

use base 'Test::InterMine::ConstraintFactory';

use Test::More;
use Test::Exception;

sub class { 'InterMine::TemplateConstraintFactory' };
sub role { 'InterMine::Constraint::Roles::Templated' };
