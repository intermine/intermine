...
my $module = 'InterMine::Query::Template';
...
my @baddies_errors = (
                       ...
                       'not well-formed',
                       'mismatched tag',
                       '\(view\) does not pass the type constraint',
