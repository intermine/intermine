...
InterMine::Constraint::Logic - the logic for combining constraints on a path in a PathQuery
...
package InterMine::Constraint::Role::Logical;

use MooseX::Role::WithOverloading;
use InterMine::Constraint::LogicalSet;
...
sub _make_node {
    my ($op, $l, $r, $rev) = @_;
    ($l, $r) = ($r, $l) if ($rev);
    return InterMine::Constraint::LogicalSet->new(op    => $op,
						  left  => $l,
						  right => $r);
}
