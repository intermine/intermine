package InterMine::PathQuery::ConstraintLogic;
...
InterMine::PathQuery::ConstraintLogic - the logic for combining constraints on a path in a PathQuery
...
sub _make_node {
    my ($op, $l, $r, $rev) = @_;
    ($l, $r) = ($r, $l) if ($rev);
    return InterMine::PathQuery::ConstraintSet->new($op, $l, $r);
}
