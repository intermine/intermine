...
InterMine::Cookbook - how to run InterMine webservice queries

=head1 DESCRIPTION

The InterMine cookbook is a set of short tutorial 'recipes'
which aim to demonstrate particular features of the InterMine
...
=item L<InterMine::Cookbook::Recipe6> - Advanced Results Management
...
=item L<InterMine::Cookbook::Recipe7> - Extending InterMine
...
=item L<InterMine::Cookbook::Recipe8> - Saving Queries
...
=item L<InterMine::Cookbook::Templates::Recipe1> - Accessing Templates
...
=item L<InterMine::Cookbook::Templates::Recipe2> - Authoring Templates
