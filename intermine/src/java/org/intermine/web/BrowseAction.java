...
/**
 * Action to handle submit from the browse box.
 *
 * @author Thomas Riley
 */
public class BrowseAction extends TemplateAction
{
    /**
     * Execute the query and forward to object details page if only one
     * result, otherwise results page.
     *
    ...
    protected ActionForward handleTemplateQuery(ActionMapping mapping,
        ...
        if (pr.getSize () == 1) {
            ...
            if (o instanceof InterMineObject) {
                return new ActionForward("/objectDetails.do?id=" + ((InterMineObject) o).getId());
            }
        }
