...
public class AbstractDataLoaderTest extends TestCase {

    protected ObjectStoreWriterOjbImpl writer;
    protected IntegrationWriterAbstractImpl iw;
    protected ArrayList toDelete;

    public AbstractDataLoaderTest(String arg) {
        super(arg);
    }
    ...
    public void setUp() throws Exception {
        ...
        iw = IntegrationWriterAbstractImpl.getInstance("source1", os, "dataloader.unittest");
    ...
    public void testStoreWithObjectRef() throws Exception {
        ...
        // check company
        Company c2 = (Company) writer.getObjectByExample(c);
    ...
    public void testStoreWithObjectRefNtoOne() throws Exception {
        ...
        // check department
        Department d2 = (Department) writer.getObjectByExample(d);
    ...
    public void testSkeletonThenRealObject() throws Exception {
        ...
        AbstractDataLoader.store(ceo, iw);

        Company ex1 = (Company) writer.getObjectByExample(c1);
        ...
        AbstractDataLoader.store(c2, iw);

        // check that vatNumber got set in company in database
        Company ex2 = (Company) writer.getObjectByExample(c2);
    ...
    public void testStoreWithCollection() throws Exception {
        ...
        Department gotD1 = (Department) writer.getObjectByExample(d1);
        ...
        Department gotD2 = (Department) writer.getObjectByExample(d2);
        ...
        // check company
        Company gotC = (Company) writer.getObjectByExample(c);
    ...
    public void testStoreWithManyToMany() throws Exception {
        ...
        AbstractDataLoader.store(c1, iw);

        // Check company 1.
        Company gotC1 = (Company) writer.getObjectByExample(c1);
        ...
        // Check company 2.
        Company gotC2 = (Company) writer.getObjectByExample(c2);
        ...
        // Check contractor 1.
        Contractor gotD1 = (Contractor) writer.getObjectByExample(d1);
        ...
        // Check contractor 2.
        Contractor gotD2 = (Contractor) writer.getObjectByExample(d2);
