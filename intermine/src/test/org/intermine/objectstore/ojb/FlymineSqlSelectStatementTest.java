...
public class FlymineSqlSelectStatementTest extends QueryTestCase
{
    ...
    public void setUpResults() throws Exception {
        results.put("SelectSimpleObject", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ ORDER BY a1_.ID");
        results.put("SubQuery", "SELECT DISTINCT a1_.a1_name AS a2_, a1_.a2_ AS a3_ FROM (SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, 5 AS a2_ FROM Company AS a1_) AS a1_ ORDER BY a1_.a1_name, a1_.a2_");
        ...
        results.put("WhereSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        results.put("WhereNotSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID NOT IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        results.put("WhereNegSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID NOT IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        ...
        results.put("SimpleGroupBy", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, COUNT(*) AS a2_ FROM Company AS a1_, Department AS a3_ WHERE (a1_.ID = a3_.companyId) GROUP BY a1_.ID, a1_.addressId, a1_.name, a1_.vatNumber ORDER BY a1_.ID, COUNT(*)");
        results.put("MultiJoin", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, a2_.ID AS a2_ID, a2_.companyId AS a2_companyId, a2_.managerId AS a2_managerId, a2_.name AS a2_name, a3_.CLASS AS a3_CLASS, a3_.ID AS a3_ID, a3_.addressId AS a3_addressId, a3_.age AS a3_age, a3_.departmentId AS a3_departmentId, a3_.departmentThatRejectedMeId AS a3_departmentThatRejectedMeId, a3_.fullTime AS a3_fullTime, a3_.name AS a3_name, a3_.salary AS a3_salary, a3_.title AS a3_title, a4_.ID AS a4_ID, a4_.address AS a4_address FROM Company AS a1_, Department AS a2_, Employee AS a3_, Address AS a4_ WHERE (a3_.CLASS = 'org.flymine.model.testmodel.CEO' OR a3_.CLASS = 'org.flymine.model.testmodel.Manager') AND ((a1_.ID = a2_.companyId) AND (a2_.managerId = a3_.ID) AND (a3_.addressId = a4_.ID) AND a3_.name = 'EmployeeA1') ORDER BY a1_.ID, a2_.ID, a3_.ID, a4_.ID");
        ...
        results.put("SelectClassAndSubClasses", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.fullTime AS a1_fullTime, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.title AS a1_title FROM Employee AS a1_ ORDER BY a1_.name, a1_.ID");
        results.put("SelectInterfaceAndSubClasses", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.businessAddressId AS a1_businessAddressId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.fullTime AS a1_fullTime, a1_.name AS a1_name, a1_.personalAddressId AS a1_personalAddressId, a1_.salary AS a1_salary, a1_.title AS a1_title FROM (SELECT 'org.flymine.model.testmodel.Contractor' AS CLASS, ID, NULL AS addressId, NULL AS age, businessAddressId, NULL AS departmentId, NULL AS departmentThatRejectedMeId, NULL AS fullTime, name, personalAddressId, NULL AS salary, NULL AS title FROM Contractor UNION SELECT CLASS, ID, addressId, age, NULL AS businessAddressId, departmentId, departmentThatRejectedMeId, fullTime, name, NULL AS personalAddressId, salary, title FROM Employee) AS a1_ ORDER BY a1_.ID");
        results.put("SelectInterfaceAndSubClasses2", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.companyId AS a1_companyId, a1_.managerId AS a1_managerId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM (SELECT 'org.flymine.model.testmodel.Company' AS CLASS, ID, addressId, NULL AS companyId, NULL AS managerId, name, vatNumber FROM Company UNION SELECT 'org.flymine.model.testmodel.Department' AS CLASS, ID, NULL AS addressId, companyId, managerId, name, NULL AS vatNumber FROM Department) AS a1_ ORDER BY a1_.ID");
        results.put("SelectInterfaceAndSubClasses3", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.businessAddressId AS a1_businessAddressId, a1_.departmentId AS a1_departmentId, a1_.departmentThatRejectedMeId AS a1_departmentThatRejectedMeId, a1_.fullTime AS a1_fullTime, a1_.name AS a1_name, a1_.personalAddressId AS a1_personalAddressId, a1_.salary AS a1_salary, a1_.title AS a1_title FROM (SELECT 'org.flymine.model.testmodel.Contractor' AS CLASS, ID, NULL AS addressId, NULL AS age, businessAddressId, NULL AS departmentId, NULL AS departmentThatRejectedMeId, NULL AS fullTime, name, personalAddressId, NULL AS salary, NULL AS title FROM Contractor UNION SELECT CLASS, ID, addressId, age, NULL AS businessAddressId, departmentId, departmentThatRejectedMeId, fullTime, name, NULL AS personalAddressId, salary, title FROM Employee WHERE CLASS = 'org.flymine.model.testmodel.CEO' OR CLASS = 'org.flymine.model.testmodel.Manager') AS a1_ ORDER BY a1_.ID");
    }
