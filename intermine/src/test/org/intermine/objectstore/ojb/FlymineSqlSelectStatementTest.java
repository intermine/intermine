...
public class FlymineSqlSelectStatementTest extends QueryTestCase
{
    ...
    public void setUpResults() throws Exception {
        results.put("SelectSimpleObject", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ ORDER BY a1_.ID LIMIT 10000 OFFSET 0");
        ...
        results.put("WhereSimpleNotEquals", "SELECT DISTINCT a1_.name AS a2_ FROM Company AS a1_ WHERE a1_.vatNumber != 1234 ORDER BY a1_.name LIMIT 10000 OFFSET 0");
        ...
        results.put("WhereSubQueryField", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.companyId AS a1_companyId, a1_.managerId AS a1_managerId, a1_.name AS a1_name FROM Department AS a1_ WHERE a1_.name IN (SELECT DISTINCT a1_.name AS a2_ FROM Department AS a1_) ORDER BY a1_.name, a1_.ID LIMIT 10000 OFFSET 0");
        ...
        results.put("Contains11", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.companyId AS a1_companyId, a1_.managerId AS a1_managerId, a1_.name AS a1_name, a2_.CLASS AS a2_CLASS, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.age AS a2_age, a2_.departmentId AS a2_departmentId, a2_.fullTime AS a2_fullTime, a2_.name AS a2_name, a2_.salary AS a2_salary, a2_.title AS a2_title FROM Department AS a1_, Employee AS a2_ WHERE (a2_.CLASS = 'org.flymine.model.testmodel.CEO' OR a2_.CLASS = 'org.flymine.model.testmodel.Manager') AND ((a1_.managerId = a2_.ID) AND a1_.name = 'DepartmentA1') ORDER BY a1_.ID, a2_.ID LIMIT 10000 OFFSET 0");
        results.put("ContainsNot11", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.companyId AS a1_companyId, a1_.managerId AS a1_managerId, a1_.name AS a1_name, a2_.CLASS AS a2_CLASS, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.age AS a2_age, a2_.departmentId AS a2_departmentId, a2_.fullTime AS a2_fullTime, a2_.name AS a2_name, a2_.salary AS a2_salary, a2_.title AS a2_title FROM Department AS a1_, Employee AS a2_ WHERE (a2_.CLASS = 'org.flymine.model.testmodel.CEO' OR a2_.CLASS = 'org.flymine.model.testmodel.Manager') AND (( NOT (a1_.managerId = a2_.ID)) AND a1_.name = 'DepartmentA1') ORDER BY a1_.ID, a2_.ID LIMIT 10000 OFFSET 0");
        ...
        results.put("SimpleGroupBy", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, COUNT(*) AS a2_ FROM Company AS a1_, Department AS a3_ WHERE (a1_.ID = a3_.companyId) GROUP BY a1_.ID, a1_.addressId, a1_.name, a1_.vatNumber ORDER BY a1_.ID, COUNT(*) LIMIT 10000 OFFSET 0");
        ...
        results.put("SelectComplex", "SELECT DISTINCT (AVG(a1_.vatNumber) + 20) AS a3_, a2_.name AS a4_, a2_.ID AS a2_ID, a2_.companyId AS a2_companyId, a2_.managerId AS a2_managerId, a2_.name AS a2_name FROM Company AS a1_, Department AS a2_ GROUP BY a2_.ID, a2_.companyId, a2_.managerId, a2_.name ORDER BY (AVG(a1_.vatNumber) + 20), a2_.name, a2_.ID LIMIT 10000 OFFSET 0");
        results.put("SelectClassAndSubClasses", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.age AS a1_age, a1_.departmentId AS a1_departmentId, a1_.fullTime AS a1_fullTime, a1_.name AS a1_name, a1_.salary AS a1_salary, a1_.title AS a1_title FROM Employee AS a1_ ORDER BY a1_.name, a1_.ID LIMIT 10000 OFFSET 0");
