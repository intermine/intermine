...
public class FlyMineSqlSelectStatementTest extends SetupDataTestCase
{
    ...
    public static void setUpResults() throws Exception {
        results.put("SelectSimpleObject", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ ORDER BY a1_.ID");
    ...
    public void testCountNoGroupByNotDistinct() throws Exception {
        ...
        assertEquals("SELECT COUNT(*) AS count_ FROM Contractor AS a1_, Company AS a2_, OldComsOldContracts AS ind_a1_a2_OldComsOldContracts_ WHERE (a1_.ID = ind_a1_a2_OldComsOldContracts_.ContractorId AND a2_.ID = ind_a1_a2_OldComsOldContracts_.CompanyId)", s1.getStatement());
    }
