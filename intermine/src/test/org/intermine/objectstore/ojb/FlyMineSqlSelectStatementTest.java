...
public class FlyMineSqlSelectStatementTest extends SetupDataTestCase
{
    ...
    public static void setUpResults() throws Exception {
        results.put("SelectSimpleObject", "SELECT Company.ID AS \"CompanyID\", Company.addressId AS \"CompanyaddressId\", Company.cEOId AS \"CompanycEOId\", Company.name AS \"Companyname\", Company.vatNumber AS \"CompanyvatNumber\" FROM Company AS Company ORDER BY Company.ID");
        results.put("SubQuery", "SELECT DISTINCT a1_.a1_name AS a2_, a1_.a2_ AS a3_ FROM (SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, 5 AS a2_ FROM Company AS a1_) AS a1_ ORDER BY a1_.a1_name, a1_.a2_");
        ...
        results.put("WhereSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        results.put("WhereNotSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID NOT IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        results.put("WhereNegSubQueryClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE a1_.ID NOT IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Company AS a1_ WHERE a1_.name = 'CompanyA') ORDER BY a1_.ID");
        results.put("WhereClassClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.cEOId AS a2_cEOId, a2_.name AS a2_name, a2_.vatNumber AS a2_vatNumber FROM Company AS a1_, Company AS a2_ WHERE (a1_.ID = a2_.ID) ORDER BY a1_.ID, a2_.ID");
        results.put("WhereNotClassClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.cEOId AS a2_cEOId, a2_.name AS a2_name, a2_.vatNumber AS a2_vatNumber FROM Company AS a1_, Company AS a2_ WHERE ( NOT (a1_.ID = a2_.ID)) ORDER BY a1_.ID, a2_.ID");
        results.put("WhereNegClassClass", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.cEOId AS a2_cEOId, a2_.name AS a2_name, a2_.vatNumber AS a2_vatNumber FROM Company AS a1_, Company AS a2_ WHERE ( NOT (a1_.ID = a2_.ID)) ORDER BY a1_.ID, a2_.ID");
        Integer id = (Integer) TypeUtil.getFieldValue(data.get("CompanyA"), "id");
        results.put("WhereClassObject", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE (a1_.ID = " + id + ") ORDER BY a1_.ID");
        ...
        results.put("ContainsMN", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.businessAddressId AS a1_businessAddressId, a1_.name AS a1_name, a1_.personalAddressId AS a1_personalAddressId, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.cEOId AS a2_cEOId, a2_.name AS a2_name, a2_.vatNumber AS a2_vatNumber FROM Contractor AS a1_, Company AS a2_, CompanysContractors AS ind_a1_a2_CompanysContractors_ WHERE ((a1_.ID = ind_a1_a2_CompanysContractors_.Companys AND a2_.ID = ind_a1_a2_CompanysContractors_.Contractors) AND a1_.name = 'ContractorA') ORDER BY a1_.ID, a2_.ID");
        results.put("ContainsDuplicatesMN", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.businessAddressId AS a1_businessAddressId, a1_.name AS a1_name, a1_.personalAddressId AS a1_personalAddressId, a2_.ID AS a2_ID, a2_.addressId AS a2_addressId, a2_.cEOId AS a2_cEOId, a2_.name AS a2_name, a2_.vatNumber AS a2_vatNumber FROM Contractor AS a1_, Company AS a2_, OldComsOldContracts AS ind_a1_a2_OldComsOldContracts_ WHERE (a1_.ID = ind_a1_a2_OldComsOldContracts_.OldComs AND a2_.ID = ind_a1_a2_OldComsOldContracts_.OldContracts) ORDER BY a1_.ID, a2_.ID");
        results.put("SimpleGroupBy", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, COUNT(*) AS a2_ FROM Company AS a1_, Department AS a3_ WHERE (a1_.ID = a3_.companyId) GROUP BY a1_.ID, a1_.addressId, a1_.cEOId, a1_.name, a1_.vatNumber ORDER BY a1_.ID, COUNT(*)");
        results.put("MultiJoin", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber, a2_.ID AS a2_ID, a2_.companyId AS a2_companyId, a2_.managerId AS a2_managerId, a2_.name AS a2_name, a3_.CLASS AS a3_CLASS, a3_.ID AS a3_ID, a3_.addressId AS a3_addressId, a3_.age AS a3_age, a3_.companyId AS a3_companyId, a3_.departmentId AS a3_departmentId, a3_.departmentThatRejectedMeId AS a3_departmentThatRejectedMeId, a3_.fullTime AS a3_fullTime, a3_.name AS a3_name, a3_.salary AS a3_salary, a3_.title AS a3_title, a4_.ID AS a4_ID, a4_.address AS a4_address FROM Company AS a1_, Department AS a2_, Employee AS a3_, Address AS a4_ WHERE (a3_.CLASS = 'org.flymine.model.testmodel.CEO' OR a3_.CLASS = 'org.flymine.model.testmodel.Manager') AND ((a1_.ID = a2_.companyId) AND (a2_.managerId = a3_.ID) AND (a3_.addressId = a4_.ID) AND a3_.name = 'EmployeeA1') ORDER BY a1_.ID, a2_.ID, a3_.ID, a4_.ID");
        ...
        results.put("SelectInterfaceAndSubClasses2", "SELECT DISTINCT a1_.CLASS AS a1_CLASS, a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.companyId AS a1_companyId, a1_.managerId AS a1_managerId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM (SELECT 'org.flymine.model.testmodel.Company' AS CLASS, ID, addressId, cEOId, NULL AS companyId, NULL AS managerId, name, vatNumber FROM Company UNION SELECT 'org.flymine.model.testmodel.Department' AS CLASS, ID, NULL AS addressId, NULL AS cEOId, companyId, managerId, name, NULL AS vatNumber FROM Department) AS a1_ ORDER BY a1_.ID");
        ...
        results.put("SelectClassObjectSubquery", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_, Department AS a2_ WHERE ((a1_.ID = 121) AND (a1_.ID = a2_.companyId) AND a2_.ID IN (SELECT DISTINCT a1_.ID AS a1_ID FROM Department AS a1_ WHERE (a1_.ID = 125))) ORDER BY a1_.ID");
        results.put("SelectUnidirectionalCollection", "SELECT DISTINCT a2_.ID AS a2_ID, a2_.name AS a2_name FROM Company AS a1_, Secretary AS a2_, CompanySecretarys AS ind_a1_a2_CompanySecretarys_ WHERE (a1_.name = 'CompanyA' AND (a1_.ID = ind_a1_a2_CompanySecretarys_.Secretarys AND a2_.ID = ind_a1_a2_CompanySecretarys_.Company)) ORDER BY a2_.ID");
        results.put("EmptyAndConstraintSet", "SELECT DISTINCT a1_.ID AS a1_ID, a1_.addressId AS a1_addressId, a1_.cEOId AS a1_cEOId, a1_.name AS a1_name, a1_.vatNumber AS a1_vatNumber FROM Company AS a1_ WHERE true ORDER BY a1_.ID");
    ...
    public void testCountNoGroupByNotDistinct() throws Exception {
        ...
        assertEquals("SELECT COUNT(*) AS count_ FROM Contractor AS a1_, Company AS a2_, OldComsOldContracts AS ind_a1_a2_OldComsOldContracts_ WHERE (a1_.ID = ind_a1_a2_OldComsOldContracts_.OldComs AND a2_.ID = ind_a1_a2_OldComsOldContracts_.OldContracts)", s1.getStatement());
    }
