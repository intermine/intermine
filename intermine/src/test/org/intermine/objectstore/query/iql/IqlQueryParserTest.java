...
public class FqlQueryParserTest extends FqlQueryTestCase
{
    ...
    public static void oneTimeSetUp() throws Exception {
        ...
        results.put("WhereSimpleNegEquals", new FqlQuery("SELECT DISTINCT a1_.name AS a2_ FROM org.flymine.model.testmodel.Company AS a1_ WHERE NOT (a1_.vatNumber = 1234)", null));
    ...
    public void testInvalidPathExpressions() throws Exception {
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c from (select Company from Company) as c", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.Company from (select Company from Company) as c", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.name.something from (select Company.name as name from Company) as c", "org.flymine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because the path expression cannot extend beyond a field");
        } catch (IllegalArgumentException e) {
            assertEquals("Path expression c.name.something extends beyond a field", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.subquery from (select subquery.Company.name as name from (select Company from Company) as subquery) as c", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.something from (select Company from Company) as c", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c from Company", "org.flymine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because there is no object c");
        } catch (IllegalArgumentException e) {
            assertEquals("No such object c", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select a.Company.name as a from (select Company.name as a from Company) as a", "org.flymine.model.testmodel"));
    ...
    public void testNormalExpressions() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select 1 + Company.vatNumber as a, 3 - 4 as b, 5 * 6 as c, 7 / 8 as d from Company", "org.flymine.model.testmodel"));
    ...
    public void testInvalidNormalExpressions() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company + 3 as a from Company", "org.flymine.model.testmodel"));
    ...
    public void testInvalidSafeFunctions() throws Exception {
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select min(Company.name) as a from Company", "org.flymine.model.testmodel"));
    ...
    public void testGroupOrder() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company group by 2 order by Company", "org.flymine.model.testmodel"));
    ...
    public void testInvalidConstraint() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company in (select Company, Company.name as name from Company)", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where Company.departments.flibble contains Department", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where Company contains Department", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from (select Company from Company) as Company, Department where Company.Company.departments contains Department", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where fkjsfd contains Department", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company is null", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company > Company", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company > Company.name", "org.flymine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company.name > Company", "org.flymine.model.testmodel"));
