...
public class FqlQueryParserTest extends FqlQueryTestCase
{
    ...
    public static void oneTimeSetUp() throws Exception {
        ...
        results.put("WhereSimpleNegEquals", new FqlQuery("SELECT DISTINCT a1_.name AS a2_ FROM org.intermine.model.testmodel.Company AS a1_ WHERE NOT (a1_.vatNumber = 1234)", null));
        results.put("WhereNegSubQueryClass", new FqlQuery("SELECT DISTINCT a1_ FROM org.intermine.model.testmodel.Company AS a1_ WHERE NOT (a1_ IN (SELECT DISTINCT a1_ FROM org.intermine.model.testmodel.Company AS a1_ WHERE a1_.name = 'CompanyA'))", null));
        results.put("WhereNegClassClass", new FqlQuery("SELECT DISTINCT a1_, a2_ FROM org.intermine.model.testmodel.Company AS a1_, org.intermine.model.testmodel.Company AS a2_ WHERE NOT a1_ = a2_", null));
        results.put("ContainsNeg11", new FqlQuery("SELECT DISTINCT a1_, a2_ FROM org.intermine.model.testmodel.Department AS a1_, org.intermine.model.testmodel.Manager AS a2_ WHERE NOT a1_.manager CONTAINS a2_ AND a1_.name = 'DepartmentA1'", null));
    ...
    public void testNotEnoughParameters() throws Exception {
        FqlQuery fq = new FqlQuery("select a1_, a2_ from Company as a1_, Department as a2_ where a1_ = ? and a2_ = ?", "org.intermine.model.testmodel");
    ...
    public void testConstants() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select 1 as b, false as c, true as d, 1.2 as e, 'hello' as f, '2003-04-30 14:12:30.333' as g from Company", "org.intermine.model.testmodel"));
    ...
    public void testValidPathExpressions() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select subquery.c_.name as a, subquery.b as b from (select c_, c_.name as b from Company as c_) as subquery", "org.intermine.model.testmodel"));
    ...
    public void testInvalidPathExpressions() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company.nonExistentField from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company.name.something from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c from (select Company from Company) as c", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.Company from (select Company from Company) as c", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.Company.nonExistentField from (select Company from Company) as c", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because that field does not exist in a Company object");
        } catch (IllegalArgumentException e) {
            assertEquals("Field nonExistentField not found in interface org.intermine.model.testmodel.Company", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.Company.name.something from (select Company from Company) as c", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because the path expression cannot extend beyond a field");
        } catch (IllegalArgumentException e) {
            assertEquals("Path expression c.Company.name.something extends beyond a field", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.name.something from (select Company.name as name from Company) as c", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because the path expression cannot extend beyond a field");
        } catch (IllegalArgumentException e) {
            assertEquals("Path expression c.name.something extends beyond a field", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.subquery from (select subquery.Company.name as name from (select Company from Company) as subquery) as c", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c.something from (select Company from Company) as c", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select c from Company", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because there is no object c");
        } catch (IllegalArgumentException e) {
            assertEquals("No such object c", e.getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select a.Company.name as a from (select Company.name as a from Company) as a", "org.intermine.model.testmodel"));
    ...
    public void testNormalExpressions() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select 1 + Company.vatNumber as a, 3 - 4 as b, 5 * 6 as c, 7 / 8 as d from Company", "org.intermine.model.testmodel"));
    ...
    public void testInvalidNormalExpressions() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company + 3 as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select 1 + 2 + 3 as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select 'flibble' + 3 as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company.name + 3 as a from Company", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because an expression must type-match");
        } catch (IllegalArgumentException e) {
    ...
    public void testSafeFunctions() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select count(*) as a, sum(Company.vatNumber + 3) as b, avg(Company.vatNumber) as c, min(Company.vatNumber) as d, substr('flibble', 3, max(Company.vatNumber)) as e from Company", "org.intermine.model.testmodel"));
    ...
    public void testInvalidSafeFunctions() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select count(5) as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select sum(5, 3) as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select substr('fdsafds', 3, 4, 5) as a from Company", "org.intermine.model.testmodel"));
            fail("Expected: IllegalArgumentException, because substr only takes three arguments");
        } catch (IllegalArgumentException e) {
            assertEquals("expecting CLOSE_PAREN, found ','", e.getCause().getMessage());
        }
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select max(Company) as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select substr('fdsafds') as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select min() as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select min(4) as a from Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select min(Company.name) as a from Company", "org.intermine.model.testmodel"));
    ...
    public void testGroupOrder() throws Exception {
        Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company group by 2 order by Company", "org.intermine.model.testmodel"));
    ...
    public void testInvalidConstraint() throws Exception {
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company in (select Company, Company.name as name from Company)", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where Company.departments.flibble contains Department", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where Company.name contains Department", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where Company.jhsfd contains Department", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from (select Company from Company) as Company, Department where Company.Company.departments contains Department", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company, Department from Company, Department where fkjsfd contains Department", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company is null", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company > Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company > Company.name", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company.name > Company", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company.name = Company.vatNumber", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company.departments = Company.vatNumber", "org.intermine.model.testmodel"));
        ...
        try {
            Query q = FqlQueryParser.parse(new FqlQuery("select Company from Company where Company.CEO = Company.vatNumber", "org.intermine.model.testmodel"));
