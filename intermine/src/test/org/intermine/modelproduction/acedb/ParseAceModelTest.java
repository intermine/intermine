...
public class ParseAceModelTest extends TestCase
{
    public ParseAceModelTest(String arg) {
        super(arg);
    }
    ...
    public void testParse1() throws Exception {
        ...
        List parsed = ParseAceModel.parse(in);
    ...
    public void testConvert1() throws Exception {
        ...
        try {
            ParseAceModel.nodeClassToDescriptor(node);
            fail("Expected: IllegalArgumentException");
        } catch (IllegalArgumentException e) {
