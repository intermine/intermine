...
/**
 * A customised JTable for the display of model class attributes.
...
public class AttributeTable extends JTable
{
    ...
    /**
     * Initialise a new AttributeTable.
     */
    public AttributeTable() {
    }

    /**
     * Initialise a new AttributeTable with the given model.
     ...
     * @return A new instance of AttributeTableModel.
     * 
     ...
     * {@link AttributeTableCellRenderer}, set on all columns.
     */
    @Override
    protected void createDefaultRenderers() {
        super.createDefaultRenderers();
        
        TableCellRenderer renderer = new AttributeTableCellRenderer();
