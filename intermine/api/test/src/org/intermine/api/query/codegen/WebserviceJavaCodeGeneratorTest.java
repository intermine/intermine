...
public class WebserviceJavaCodeGeneratorTest extends TestCase {
    ...
    private String serviceRootURL = "http://www.flymine.org";
    private String projectTitle = "FlyMine";
    ...
    public void testPathQueryCodeGenerationWithNoConstraints() {
        ...
        String expected = "package flymine;" + ENDL + ENDL +
        ...
        "/**" + ENDL +
        SPACE + "* This is an automatically generated Java program to run the FlyMine query." + ENDL +
        SPACE + "*" + ENDL +
        SPACE + "* @auther FlyMine" + ENDL +
        SPACE + "*" + ENDL +
        SPACE + "**/" + ENDL +
