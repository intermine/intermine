 ...
 * 
 * @author Alex Kalderimis after Fengyuan Hu
 */
public class WebservicePythonCodeGeneratorTest extends TestCase
{
    ...
    private WebservicePythonCodeGenerator cg;
    ...
    public void testPathQueryCodeGenerationWithNullQuery() {
        ...
        WebserviceCodeGenInfo wsCodeGenInfo = new WebserviceCodeGenInfo(pathQuery, serviceRootURL,
     ...
     * 
     * Test PathQuery: <query name="" model="genomic"
     * view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol
     * Gene.name Gene.organism.shortName" sortOrder="Gene.primaryIdentifier
     * asc"> </query>
     * 
     ...
     * 
     * Test PathQuery: <query name="" model="genomic"
     * view="Gene.primaryIdentifier" sortOrder="Gene.primaryIdentifier asc">
     * </query>
     * 
     */
    public void testPathQueryCodeGenerationWithOneView() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            + ENDL
            + ENDL
            + "# This is an automatically generated script to run the modMine_Test-2.M query"
            + ENDL
    ...
    /**
     * This method tests when a path query has no constraints and more than one
     * view.
     * 
     * Test PathQuery: <query name="" model="genomic"
     * view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol
     ...
     * view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol
     * Gene.name Gene.organism.shortName" sortOrder="Gene.primaryIdentifier
     * asc"> <join path="Gene.organism" style="OUTER"/> </query>
     * 
     */
    public void testPathQueryCodeGenerationWithJoinStatus() {
        String queryXml = "<query name=\"\" model=\"genomic\" view=\"Gene.primaryIdentifier "
            ...
            + "<join path=\"Gene.organism\" style=\"OUTER\"/>" + "</query>";
        // Parse xml to PathQuery - PathQueryBinding
        PathQuery pathQuery = PathQueryBinding.unmarshalPathQuery(new StringReader(queryXml),
            PathQuery.USERPROFILE_VERSION);
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ");"
            + ENDL
            + ENDL + "print $query->results(as => 'string').\"\\n\";" + ENDL;
     ...
     * Test PathQuery: <query name="" model="genomic"
     * view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol
     * Gene.name Gene.organism.shortName"> </query>
     * 
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.secondaryIdentifier" op="=" value="zen"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.NOT_EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.secondaryIdentifier" op="!=" value="zen"/> </query>
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.MATCHES
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.organism.commonName" op="LIKE" value="D.*"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.DOES_NOT_MATCH
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.organism.commonName" op="NOT LIKE" value="D.*"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.GREATER_THAN
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene.length"
     * op="&gt;" value="1024"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.GREATER_THAN_EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene.length"
     * op="&gt;=" value="1024"/> </query>
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.LESS_THAN
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene.length"
     * op="&lt;" value="1024"/> </query>
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintAttribute ConstraintOp.LESS_THAN_EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene.length"
     * op="&lt;=" value="1024"/> </query>
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintLookup ConstraintOp.LOOKUP
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene"
     * op="LOOKUP" value="zen" extraValue="C. elegans"/> </query>
     */
    public void testPathQueryCodeGenerationWithConstraintLookup() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ENDL
            + INDENT
            + "extra_value => 'C. elegans',"
            + ENDL
            + ");" + ENDL + ENDL + "print $query->results(as => 'string').\"\\n\";" + ENDL;
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintBag ConstraintOp.IN
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene" op="IN"
     * value="aList"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintBag ConstraintOp.NOT_IN
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint path="Gene"
     * op="NOT IN" value="aList"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintMultiValue ConstraintOp.ONE_OF
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.organism.commonName" op="ONE OF"> <value>fruit fly </value>
     * <value>honey bee </value> </constraint> </query>
     */
    public void testPathQueryCodeGenerationWithConstraintOneOfValues() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + INDENT
            + "],"
            + ENDL + ");" + ENDL + ENDL + "print $query->results(as => 'string').\"\\n\";" + ENDL;
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintMultiValue ConstraintOp.NONE_OF
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.organism.commonName" op="NONE OF"> <value>fruit fly </value>
     * <value>honey bee </value> </constraint> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintNull ConstraintOp.IS_NOT_NULL
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.primaryIdentifier" op="IS NOT NULL"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintNull ConstraintOp.IS_NULL
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.primaryIdentifier" op="IS NULL"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintLoop ConstraintOp.EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.proteins.genes" op="=" loopPath="Gene"/> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintLoop ConstraintOp.NOT_EQUALS
     * 
     * Test PathQuery: <query name="" model="genomic" view="Gene.primaryIdentifier Gene.secondaryIdentifier Gene.symbol Gene.name Gene.organism.shortName"
     * sortOrder="Gene.primaryIdentifier asc"> <constraint
     * path="Gene.proteins.genes" op="!=" loopPath="Gene"/> </query>
     ...
     * <constraint path="Gene.organism.shortName" code="A" op="="
     * value="D. melanogaster"/> <constraint path="Gene" code="B" op="LOOKUP"
     * value="zen" extraValue=""/> <constraint path="Gene.organism.commonName"
     * code="C" op="ONE OF"> <value>fruit fly </value> <value>honey bee </value>
     * </constraint> </query>
     */
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintIds ConstraintOp.IN
     * 
     * Can not be tested
     * 
     * Test PathQuery:
    ...
    /**
     * This method tests when a path query has one constraint -
     * PathConstraintIds ConstraintOp.NOT_IN
     * 
     * Can not be tested
     * 
     * Test PathQuery:
    ...
    public void testTemplateQueryCodeGenerationWithNullQuery() {
        ...
        WebserviceCodeGenInfo wsCodeGenInfo = new WebserviceCodeGenInfo(templateQuery,
            serviceRootURL, projectTitle, perlWSModuleVer);
    ...
    /**
     * This method tests when a template query has one constraint -
     * PathConstraintAttribute ConstraintOp.EQUALS
     */
    public void testTemplateQueryCodeGenerationWithConstraintEq() {
        ...
        Map<String, TemplateQuery> tqs = TemplateQueryBinding.unmarshal(new StringReader(queryXml),
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            + ENDL
            + ENDL
            + "# This is an automatically generated script to run the modMine_Test-2.M template"
            + ENDL
            + "# You should install the Webservice::InterMine modules to run this example, e.g. sudo cpan Webservice::InterMine"
            + ENDL
            + ENDL
            + "# template name - im_available_organisms"
            + ENDL
            + "# template description - For all genes, list the taxonIds available.  Used by webservice to construct links to other intermines."
            + ENDL
            + ENDL
            ...
            + "# You can edit the constraint values below"
            + ENDL
            + "# A    Gene.primaryIdentifier    no constraint description"
            + ENDL
            + ENDL
    ...
    public void testTemplateQueryCodeGenerationWithConstraintLike() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ENDL
            + ENDL
            + "# template name - Organism_Gene"
            + ENDL
            + "# template description - Show all the genes for a particular organism."
            + ENDL
            + ENDL
            + "my $template = Webservice::InterMine->template('Organism_Gene')"
            + ENDL
            + INDENT
            + "or die 'Could not find template';"
            + ENDL
            ...
            + "# You can edit the constraint values below"
            + ENDL
            + "# A    Gene.organism.name    Show all the genes from organism:"
            + ENDL
            + ENDL
            + "my $results = $template->results_with("
            + ENDL
    ...
    public void testTemplateQueryCodeGenerationWithConstraintLookup() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ENDL
            + ENDL
            + "# template name - Clone_gene"
            + ENDL
            + "# template description - For a cDNA clone or list of clones give the corresponding gene identifiers."
            + ENDL
            + ENDL
            + "my $template = Webservice::InterMine->template('Clone_gene')"
            + ENDL
            + INDENT
            + "or die 'Could not find template';"
            + ENDL
            ...
            + "# You can edit the constraint values below"
            + ENDL
            + "# A    CDNAClone    Show corresponding genes for clone(s):"
            + ENDL
            + ENDL
            + "my $results = $template->results_with("
            + ENDL
    ...
    public void testTemplateQueryCodeGenerationWithConstraintIsNotNull() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ENDL
            + ENDL
            + "# template name - AAANotNull"
            + ENDL
            + "# template description - no description"
            + ENDL
            + ENDL
            + "my $template = Webservice::InterMine->template('AAANotNull')"
            + ENDL
            + INDENT
            + "or die 'Could not find template';"
            + ENDL
    ...
    /**
     * This method tests when a path template has one constraint -
     * PathConstraintNull ConstraintOp.IS_NULL
     */
    ...
    public void testTemplateQueryCodeGenerationWithTwoAndMoreConstraints() {
        ...
        String expected = "use Webservice::InterMine 0.9412 'http://newt.flymine.org:8080/modminepreview/service';"
            ...
            + ENDL
            + ENDL
            + "# template name - Gene_OrthologueOrganism_new"
            + ENDL
            + "# template description - For a particular gene, show predicted orthologues in one particular organism.  "
            + ENDL
            + ENDL
            + "my $template = Webservice::InterMine->template('Gene_OrthologueOrganism_new')"
            + ENDL
            + INDENT
            + "or die 'Could not find template';"
            + ENDL
            ...
            + "# You can edit the constraint values below"
            + ENDL
            + "# D    Gene    no constraint description"
            + ENDL
            + "# A    Gene.homologues.homologue.organism.name    In organism:"
            + ENDL
            + ENDL
            + "my $results = $template->results_with("
            + ENDL
