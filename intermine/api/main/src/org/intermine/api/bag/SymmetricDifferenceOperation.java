...
public class SymmetricDifferenceOperation extends BagOperation {

    public SymmetricDifferenceOperation(Model model,
            Collection<InterMineBag> bags, Profile profile) {
