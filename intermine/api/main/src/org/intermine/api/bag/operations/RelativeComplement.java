...
public class RelativeComplement extends BagOperation
{
    ...
    public RelativeComplement(
        Model model, Profile profile, Collection<InterMineBag> froms, Collection<InterMineBag> exclude) {
    ...
    public String getNewBagType() throws IncompatibleTypes {
        try {
            ...
            for (InterMineBag bag: excluded) {
                ...
                findIntersectionType(asList(leftType, model.getClassDescriptorByName(bag.getType())));
            }
