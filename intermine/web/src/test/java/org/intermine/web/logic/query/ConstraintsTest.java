...
public class ConstraintsTest extends TestCase
{
    ...
    public void testLike() {
        ...
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee.name\" op=\"LIKE\" value=\"monkey\"/></query>", q.toXml(1));
    }

    public void testLookup() {
        PathQuery q = new PathQuery(Model.getInstanceByName("testmodel"));
        q.addConstraint(Constraints.lookup("Employee.name", "bob", null));
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee.name\" op=\"LOOKUP\" value=\"bob\"/></query>", q.toXml(1));
    }

    public void testIn() {
        PathQuery q = new PathQuery(Model.getInstanceByName("testmodel"));
        q.addConstraint(Constraints.in("Employee", " "));
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee\" op=\"IN\" value=\" \"/></query>", q.toXml(1));
    }
    ...
    public void testIsNull() {
        ...
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee.name\" op=\"IS NULL\"/></query>", q.toXml(1));
    }

    public void testIsNotNull() {
        PathQuery q = new PathQuery(Model.getInstanceByName("testmodel"));
        q.addConstraint(Constraints.isNotNull("Employee.name"));
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee.name\" op=\"IS NOT NULL\"/></query>", q.toXml(1));
    }

    public void testGreaterThan() {
        PathQuery q = new PathQuery(Model.getInstanceByName("testmodel"));
        q.addConstraint(Constraints.greaterThan("Employee.length", "1"));
        assertEquals("<query name=\"query\" model=\"testmodel\" view=\"\" longDescription=\"\"><constraint path=\"Employee.length\" op=\"&gt;\" value=\"1\"/></query>", q.toXml(1));
    }
