 ...
 */
public final class InterMineLinkGenerator
{
    private static final Logger LOG = Logger.getLogger(InterMineLinkGenerator.class);
    private InterMineLinkGenerator() {
        // don't instantiate
    }
     ...
     * @throws UnsupportedEncodingException if fail to encode organism name
     */
    public static void getGenes(LinkManager olm, Map<String, JSONObject> filteredMines,
