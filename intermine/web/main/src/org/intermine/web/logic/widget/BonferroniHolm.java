 ...
 *  2) The p-value is multiplied by the total number of tests minus its rank.
 *
 * @author Julie Sullivan
 */
public class BonferroniHolm implements ErrorCorrection
{
    ...
    * @param testCount number of tests
     */
    public BonferroniHolm(HashMap<String, BigDecimal> originalMap, int testCount) {
    ...
    public void calculate(Double max) {
        ...
        for (Map.Entry<String, BigDecimal> entry : originalMap.entrySet()) {
            ...
            // n - rank
            BigDecimal m = numberOfTests.subtract(index, MathContext.DECIMAL128);
